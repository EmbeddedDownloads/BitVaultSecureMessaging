package com.app.securemessaging.util.floatingactionmenu;
                    ...
                    mUiHandler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (label != null && label.isHandleVisibilityChanges()) {
                                ...
                                label.setBackgroundColor(ContextCompat.getColor(getContext(), R.color.bg_color));
                                label.setTextColor(ContextCompat.getColor(getContext(), R.color.all_text_color));
                            }
                        }
                    }, delay);
